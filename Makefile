...
METAL_SRC := src/kernels/forward.metal src/kernels/backward.metal
...
$(METAL_BIN): $(METAL_SRC)
	...
	xcrun -sdk macosx metallib build/kernels/forward.air build/kernels/backward.air -o $(METAL_BIN)
